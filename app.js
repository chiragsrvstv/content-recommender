...
app.post("/tonight/movies/moviesresults", function(req, res) {
  ...
  console.log(genres);
  const url3 =
    "https://api.themoviedb.org/3/movie/top_rated?api_key=90dc517176585a03c348c93afdd70126&language=en-US&region=US,IN&include_adult=true&include_video=false&page=1&with_genres=" +
    genres;
