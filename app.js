...
app.post("/tonight/movies/moviesresults", function(req, res) {
  ...
  console.log(genres);
  const url3 =
    "https://api.themoviedb.org/3/discover/movie?api_key=***REMOVED***&language=en-US&sort_by=popularity.desc&region=IN,US&include_adult=true&include_video=false&page=1&with_genres=" +
    genres;
...
app.post("/tonight/tvserie/tvresults", function(req, res) {
  ...
  const tvResultsUrl = "https://api.themoviedb.org/3/discover/tv?api_key=***REMOVED***&language=en-US&sort_by=popularity.desc&page=1&timezone=America%2FNew_York&include_null_first_air_dates=false&with_genres="+
  genres;
