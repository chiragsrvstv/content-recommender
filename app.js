...
app.get("/tonight/movies", function (req, res) {
  ...
  //api key
  key = '***REMOVED***'
  const url1 = 'https://api.themoviedb.org/3/discover/movie?api_key=***REMOVED***&language=en-US&sort_by=popularity.desc&region=IN&year=2019&include_adult=true&include_video=false&page=1'
...
app.get("/tonight/tvseries", function (req, res) {
  const url2 = 'https://api.themoviedb.org/3/discover/tv?api_key=***REMOVED***&language=en-US&region=IN&sort_by=popularity.desc&page=1&include_null_first_air_dates=false'
